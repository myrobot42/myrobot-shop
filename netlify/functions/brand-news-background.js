// netlify/functions/brand-news-background.js
// BACKGROUND FUNCTION (runs up to 15 min). Same logic as scheduled brand-news-refresh.js, but invokable
// on demand by visiting /.netlify/functions/brand-news-background  — use it to test the
